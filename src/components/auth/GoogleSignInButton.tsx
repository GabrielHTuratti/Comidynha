...
const GoogleSignInButton: React.FC<GoogleSignInButtonProps> = ({
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      console.log("Usuário autenticado com sucesso pelo Firebase:", user)
      ...
      console.log("Login processado com sucesso:", data)
      ...
      try {
        ...
        console.error("Erro ao buscar perfil após login Google:", error)
      }
